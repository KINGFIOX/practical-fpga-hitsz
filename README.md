...
```sh
git clone git@github.com:KINGFIOX/practical-fpga-hitsz.git
cd practical-fpga-hitsz
```
...
#### Commit your changes
```sh
git commit -m 'Starting practical-fpga-hitsz'
...
```sh
mill practical-fpga-hitsz.test
```
